...
The sections below used to live on this page. Links to their old anchors still land here.

#### Concepts

[docs/concepts.md](docs/concepts.md), along with Terminology, Parallel Chunking, Seeds and Reflinks, and Tar Interoperability.

#### Store Backends

[docs/stores.md](docs/stores.md), along with Capabilities, Store Architecture, Chaining and Caching, Failover Groups, Compressed vs Uncompressed, and Remote Indexes.

#### S3 Store URLs

[docs/stores-s3.md](docs/stores-s3.md).

#### OCI Registry Stores

[docs/stores-oci.md](docs/stores-oci.md), along with Indexes in a registry, Authentication, and Pruning.
...
[docs/cli/](docs/cli/), along with Commands, Common Options, and Environment Variables.

#### Configuration

[docs/configuration.md](docs/configuration.md), along with Dynamic Store Configuration, Configuration Reference, and Example Config.

#### Examples

[docs/cookbook.md](docs/cookbook.md), along with Extraction, Chunking, Cache and Store Management, Archives, Server Examples, and Update Size Estimation.
